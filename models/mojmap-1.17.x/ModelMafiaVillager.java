...
public class ModelMafiaVillager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mafiavillager"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 2)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 55)
		...
		PartDefinition bone = head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(54, 0).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 4.0F,
		...
		PartDefinition gun7 = arms.addOrReplaceChild("gun7",
				CubeListBuilder.create().texOffs(9, 49)
						.addBox(-3.052F, -21.7867F, -6.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.2F)).texOffs(29, 52)
						.addBox(-3.552F, -21.4867F, -6.7F, 2.0F, 0.0F, 1.0F, new CubeDeformation(-0.4F)),
				PartPose.offset(2.25F, 20.75F, -4.05F));

		PartDefinition gun8 = gun7
				.addOrReplaceChild("gun8",
						CubeListBuilder.create().texOffs(17, 51).addBox(-3.052F, -20.9212F, 0.4472F, 1.0F, 3.0F, 1.0F,
								new CubeDeformation(0.1F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition gun9 = gun7.addOrReplaceChild("gun9", CubeListBuilder.create().texOffs(21, 51)
				.addBox(-3.552F, -21.7093F, -1.4019F, 2.0F, 3.0F, 1.0F, new CubeDeformation(-0.6F)).texOffs(21, 51)
				.addBox(-3.552F, -19.7093F, -1.6019F, 2.0F, 1.0F, 3.0F, new CubeDeformation(-0.6F)),
