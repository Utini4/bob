...
public class Modelalcoholic<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "alcoholic"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition sticks = partdefinition.addOrReplaceChild("sticks", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition stick6 = sticks.addOrReplaceChild("stick6",
				CubeListBuilder.create().texOffs(0, 16)
						.addBox(8.0F, 3.0F, -5.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(-0.25F)).texOffs(13, 16)
