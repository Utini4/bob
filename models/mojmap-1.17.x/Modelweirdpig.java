...
public class Modelweirdpig<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "weirdpig"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(28, 8).addBox(-5.0F, -10.0F, -10.0F, 10.0F, 16.0F, 8.0F,
						new CubeDeformation(-1.0F)),
				PartPose.offsetAndRotation(0.0F, 11.0F, 2.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-4.0F, -3.0F, -7.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(-1.0F)),
				PartPose.offset(0.0F, 13.0F, -5.0F));

		PartDefinition bone = head.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(16, 16).addBox(-2.0F, -12.0F, -15.0F, 4.0F, 3.0F, 1.0F,
						new CubeDeformation(-1.0F)),
		...
		PartDefinition leg1 = partdefinition.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 16).addBox(
				-8.0F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-1.0F)), PartPose.offset(3.0F, 18.0F, 7.0F));

		PartDefinition leg2 = partdefinition.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 16).addBox(
				4.0F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-1.0F)), PartPose.offset(-3.0F, 18.0F, 7.0F));

		PartDefinition leg3 = partdefinition.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 16).addBox(
				-8.0F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-1.0F)), PartPose.offset(3.0F, 18.0F, -5.0F));

		PartDefinition leg4 = leg3.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(0, 16).addBox(4.0F, 1.0F,
				-2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-1.0F)), PartPose.offset(-6.0F, 0.0F, 0.0F));
