...
import net.mcreator.remakingeverything.procedures.MinionRightClickedOnEntityProcedure;
...
public class MinionEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(RemakingEverythingModEntities.MINION, 200, 1, 3));
	}

	public MinionEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(RemakingEverythingModEntities.MINION, world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		MinionRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MinionEntity retval = RemakingEverythingModEntities.MINION.create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(RemakingEverythingModEntities.MINION, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
