...
public class GhastwithsaddleEntity extends TamableAnimal {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(RemakingEverythingModEntities.GHASTWITHSADDLE, 58, 1, 1));
	}

	public GhastwithsaddleEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(RemakingEverythingModEntities.GHASTWITHSADDLE, world);
	}

	public GhastwithsaddleEntity(EntityType<GhastwithsaddleEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GhastwithsaddleEntity retval = RemakingEverythingModEntities.GHASTWITHSADDLE.create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(RemakingEverythingModItems.GHAST_SNACKS).contains(stack);
	}
	...
	public static void init() {
		SpawnPlacements.register(RemakingEverythingModEntities.GHASTWITHSADDLE, SpawnPlacements.Type.ON_GROUND,
