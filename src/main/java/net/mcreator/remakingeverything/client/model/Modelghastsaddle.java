...
public class Modelghastsaddle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("remaking_everything", "modelghastsaddle"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body2 = body.addOrReplaceChild("body2",
				CubeListBuilder.create().texOffs(98, 42).addBox(-5.0F, -10.7F, 3.8F, 10.0F, 16.0F, 8.0F, new CubeDeformation(3.3F)),
		...
		PartDefinition tentacle1 = partdefinition.addOrReplaceChild("tentacle1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.4F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.7F, 11.0F, -5.0F));
		PartDefinition tentacle2 = partdefinition.addOrReplaceChild("tentacle2",
				CubeListBuilder.create().texOffs(0, 0).addBox(6.6F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.3F, 11.0F, -5.0F));
		PartDefinition tentacle3 = partdefinition.addOrReplaceChild("tentacle3",
				CubeListBuilder.create().texOffs(0, 0).addBox(6.6F, 0.0F, -1.0F, 2.0F, 13.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.3F, 11.0F, -5.0F));
		PartDefinition tentacle4 = partdefinition.addOrReplaceChild("tentacle4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-13.6F, 0.0F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(6.3F, 11.0F, 0.0F));
		PartDefinition tentacle5 = partdefinition.addOrReplaceChild("tentacle5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.6F, 0.0F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.3F, 11.0F, 0.0F));
		PartDefinition tentacle6 = partdefinition.addOrReplaceChild("tentacle6",
				CubeListBuilder.create().texOffs(0, 0).addBox(6.4F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.7F, 11.0F, 0.0F));
		PartDefinition tentacle7 = partdefinition.addOrReplaceChild("tentacle7",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.4F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.7F, 11.0F, 5.0F));
		PartDefinition tentacle8 = partdefinition.addOrReplaceChild("tentacle8",
				CubeListBuilder.create().texOffs(0, 0).addBox(6.6F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.3F, 11.0F, 5.0F));
		PartDefinition tentacle9 = partdefinition.addOrReplaceChild("tentacle9",
				CubeListBuilder.create().texOffs(0, 0).addBox(6.6F, 0.0F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.3F, 11.0F, 5.0F));
